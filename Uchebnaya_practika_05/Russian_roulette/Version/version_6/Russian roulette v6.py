...
class modes:
    def modes_1():
        ...
        btn = Button(frame, image=photo1, borderwidth=0, activebackground='white', bg='white',
                     command=lambda: modes.toggle_image(current_state3, current_state4, btn, photo2, btn2, photo1_a))
        btn.image = photo1
        ...
        btn2 = Button(frame, image=photo1_a, activebackground='white',
                      command=lambda: modes.toggle_image2(current_state4,current_state3, btn2, photo2_b, btn, photo1),
        ...
        current_state21 = 1
        btn1 = Button(frame, image=photo11, borderwidth=0, activebackground='white', bg='white',
                      command=lambda: modes.toggle_image1(current_state1, current_state21,
                                                          btn1, photo21, btn21, photo1_a1))
        btn1.image = photo1
        btn1.place(x=380, y=400)
        btn21 = Button(frame, image=photo1_a1, activebackground='white',
                       command=lambda: modes.toggle_image21(current_state21, current_state1,
                                                            btn21, photo2_b1, btn1, photo11), borderwidth=0, bg='white')
        ...
        label4.image = photo4
        btn4 = Button(frame, image=photo4, activebackground='white', borderwidth=0, bg='white',
                      command=lambda: modes.modes_2(mode_firearm, mode_players))
        btn4.place(x=1050, y=690)

    def toggle_image(s, sq, q, photo2, qq, photo1_a):
        play_once("Sounds\\knopka-vyiklyucheniya-na-nastolnoy-lampe1.wav")
        global mode_players, current_state3, current_state4, btn, btn2
        btn2 = qq
        current_state4 = sq
        current_state3 = s
        btn = q
    ...
    def toggle_image2(s, sq, q, photo2_b, qq, photo1):
        play_once("Sounds\\knopka-vyiklyucheniya-na-nastolnoy-lampe1.wav")
        global current_state4, current_state3, btn2, btn, mode_players
        btn = qq
        current_state3 = sq
        current_state4 = s
        btn2 = q
    ...
    def toggle_image1(s, sq, q, photo21, qq, photo1_a1):
        play_once("Sounds\\knopka-vyiklyucheniya-na-nastolnoy-lampe1.wav")
        global current_state1, current_state21, btn1, btn21, mode_firearm
        btn21 = qq
        current_state21 = sq
        current_state1 = sq
        btn1 = q
    ...
    def toggle_image21(s, sq, q, photo2_b1, qq, photo11):
        play_once("Sounds\\knopka-vyiklyucheniya-na-nastolnoy-lampe1.wav")
        global current_state21, current_state1, btn21, btn1, mode_firearm
        btn1 = qq
        current_state1 = sq
        current_state21 = s
        btn21 = q
    ...
    def mode_roulette():
        ...
        label6.image = photo6
        btn6 = Button(frame, image=photo6, activebackground='white', borderwidth=0, bg='white',
                      command= modes.modes3_roulette)
...
class game:
    def roulette_1():
        play_once("Sounds\\knopka-vyiklyucheniya-na-nastolnoy-lampe1.wav")
        clear_window()
        global a, title3, rating_1, life_2, action
        action=0
        ...
        if current_state2 == 1:
            btn2 = Button(frame, image=photo1_a, activebackground='white',
                          command=lambda: game.toggle_image2(current_state2, btn2, photo1_a, photo2_b),
                          borderwidth=0,bg='white')
            btn2.image = photo1_a
        ...
        def result():
            ...
            if life_2 == 0:
                ...
                tk.Label(window, text="ВЫ ВЫИГРАЛИ!", font=("Arial", 30),
                         bg="white").place(relx=0.12, rely=0.12, relwidth=0.76, relheight=0.09)
                life_2 += 1
            else:
                play_once("Sounds\\02c25f2abdd7bbb.wav")
                tk.Label(window, text="ВЫ ПРОИГРАЛИ!", font=("Arial", 30),
                         bg="white").place(relx=0.12, rely=0.12, relwidth=0.76, relheight=0.09)
        ...
        def opp_shot():
            play_once("Sounds\\knopka-vyiklyucheniya-na-nastolnoy-lampe1.wav")
            global a, rating_1, life_2, action
    ...
    def toggle_image(s, q, photo2, photo1):
        ...
        if s == 1:
            ...
            stop_flag = False
            loop_thread = threading.Thread(target=loop_sound,
                                           args=("Sounds\\pixelated-love-20240608-171951.wav",), daemon=True)
            loop_thread.start()
            btn.config(image=photo1)
            btn.image = photo1
            btn.place(x=110, y=33)
    ...
    def roulette_2():
        ...
        def result():
            ...
            if life_2 == 0:
                tk.Label(window, text="1 игрок выиграл", font=("Arial", 30),
                         bg="white").place(relx=0.12, rely=0.12, relwidth=0.76, relheight=0.09)
                tk.Label(window, text="2 игрок проиграл", font=("Arial", 30),
                         bg="white").place(relx=0.12, rely=0.22, relwidth=0.76, relheight=0.09)
                life_2 += 1
            else:
                tk.Label(window, text="1 игрок проиграл", font=("Arial", 30),
                         bg="white").place(relx=0.12, rely=0.12, relwidth=0.76, relheight=0.09)
                tk.Label(window, text="2 игрок выиграл", font=("Arial", 30),
                         bg="white").place(relx=0.12, rely=0.22, relwidth=0.76, relheight=0.09)
    ...
    def shotgun_1():
        clear_window()
        global blank_patron, n, life_1, life_2, a, rating_1, btn33, action
        action=0
        life_1=3
        rating_1=0
        life_2=3
        ...
        def show_blank_info():
            ...
            if (x == 1) or (l == 2):
                return
            label_info = tk.Label(frame, text=f"В ДРОБОВИКЕ {blank_patron} ХОЛОСТЫХ ПАТРОНОВ", font=("Arial", 15),
        ...
        def move_opp():
            global n, a, rating_1, blank_patron, life_1, life_2, k, q, l, recharge, action, movee
            action=1
            movee=1
            while action != 0 and movee==1:
                    a = random.randint(1, n)
                    b = random.randint(1, 2)
                    if a > blank_patron:
                        action = 0
...
class settings:
    ...
    def toggle_image(s, q, photo2, photo1):
        ...
        if s == 1:
            ...
            stop_flag = False
            loop_thread = threading.Thread(target=loop_sound, args=("Sounds\\pixelated-love-20240608-171951.wav",),
                                           daemon=True)
            loop_thread.start()
            btn.config(image=photo1)
            btn.image = photo1
